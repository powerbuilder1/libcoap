...
#define COAP_PROTO_RELIABLE(p) ((p) == COAP_PROTO_TCP || (p) == COAP_PROTO_TLS || (p) == COAP_PROTO_WS || (p) == COAP_PROTO_WSS)
...
/**
 * Get fd from corresponding endpoint
 *
 * @param endpoint The given COAP endpoint
